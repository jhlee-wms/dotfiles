...
#PROMPT='%(!.%B%F{red}.%B%F{green}%n) $(random_emoji) %F{blue}%(!.%1~.%~) ${vcs_info_msg_0_}%F{blue}%(!.#.$)%k%b%f '
PROMPT='%(!.%B%F{red}.%B%F{magenta}%n@)%m $(random_emoji) %F{cyan}%(!.%1~.%~) ${vcs_info_msg_0_}%F{blue}%(!.#.$)%k%b%f '
PROMPT='%(!.%B%F{red}.%B%F{green}%n@)%m $(random_emoji) %F{blue}%(!.%1~.%~) ${vcs_info_msg_0_}%F{blue}%(!.#.$)%k%b%f '
